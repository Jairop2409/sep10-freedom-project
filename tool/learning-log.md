...
* read docuemantation of positioning on  the Aframe [page](https://aframe.io/docs/1.5.0/components/position.html)
...
### Next steps
* Try other components and the meaning of them and how I can use that on my fp(freedom) project
